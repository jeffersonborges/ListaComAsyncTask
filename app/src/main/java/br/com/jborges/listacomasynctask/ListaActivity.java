package br.com.jborges.listacomasynctask;
...
import br.com.jborges.listacomasynctask.Listener.OnItemClickListener;
import br.com.jborges.listacomasynctask.adapter.AndroidAdapter;
import br.com.jborges.listacomasynctask.model.Android;
...
public class ListaActivity extends AppCompatActivity {
    ...
    private final int URL_SERVICO = 0;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(ListaActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL(params[URL_SERVICO]);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Toast.makeText(ListaActivity.this, e.toString(), Toast.LENGTH_LONG).show();
            }
    ...
    private void setUpRecyclerView(List<Android> data) {
        ...
        RecyclerView rcLista = (RecyclerView) findViewById(R.id.rvLista);
        mAdapter = new AndroidAdapter(ListaActivity.this, data);
        rcLista.setAdapter(mAdapter);
        rcLista.setLayoutManager(new LinearLayoutManager(ListaActivity.this));
